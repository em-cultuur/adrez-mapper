...
const FieldTextSet = require('../field/field-text-set').FieldTextSet
...
describe('text-binary',  () => {
  ...
  it('empty', async () => {
    let f = new FieldTextSet({value: {'add': 1, 'update': 2, 'delete': 4}});
    logger.clear();
  ...
  it('add', async () => {
    let f = new FieldTextSet({values: {'add': 1, 'update': 2, 'delete': 4}});
    logger.clear();
